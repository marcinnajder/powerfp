...
const { return_: observable__return_, map: observable__map, bind: observable__bind, apply:observable__apply } = observable;

// functor, monad, applicative functor
export const observableFunctorOps: FOps = { map: observable__map };
export const observableMonadOps: MOps = { return_: observable__return_, bind: observable__bind };
export const observableApplicativeOps: AOps = { map: observable__map, return_: observable__return_, apply: observable__apply };


// return, map, bind, apply
export function observableReturn<T>(value: T): Observable<T> {
    return observable__return_(value);
}
...
export function observableMap(mf: any, f?: any): any {
    return callMap(observable__map, mf, f);
}
...
export function observableBind(mf: any, f?: any): any {
    return callBind(observable__bind, mf, f);
}
...
export function observableApply(f: any, m?: any): any {
    return callApply(observable__apply, f, m);
}
...
export function observableLiftM2<T1, T2, R>(f: f3<T1, T2, R>, m1: Observable<T1>, m2: Observable<T2>): Observable<R> {
    return liftM2(observableMonadOps, f, m1, m2) as Observable<R>;
}
export function observableLiftM3<T1, T2, T3, R>(f: f4<T1, T2, T3, R>, m1: Observable<T1>, m2: Observable<T2>, m3: Observable<T3>): Observable<R> {
    return liftM3(observableMonadOps, f, m1, m2, m3) as Observable<R>;
}
export function observableLiftM4<T1, T2, T3, T4, R>(f: f5<T1, T2, T3, T4, R>, m1: Observable<T1>, m2: Observable<T2>, m3: Observable<T3>, m4: Observable<T4>): Observable<R> {
    return liftM4(observableMonadOps, f, m1, m2, m3, m4) as Observable<R>;
}
